                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body text-center">
                                ...
                                <div class="text-start mt-3 info-personal">
                                    <p class="mb-2">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        <?php echo date('d/m/Y', strtotime($guia['fecha_nacimiento'])); ?>
                                    </p>
                                    <p class="mb-2">
                                        <i class="fas fa-home text-secondary"></i>
                                        <?php echo nl2br(htmlspecialchars($guia['domicilio'])); ?>
                                    </p>
                                    <p class="mb-2">
                                        <i class="fas fa-id-card text-warning"></i>
                                        <?php echo htmlspecialchars($guia['curp']); ?>
                                    </p>
                                    <p class="mb-0">
